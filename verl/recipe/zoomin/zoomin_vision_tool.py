...
class ZoominVisionTool(BaseTool):
    ...
    async def execute(self, instance_id: str, parameters: dict[str, Any], image_data: list[Image.Image], **kwargs) -> Tuple[str | Dict[str, Any], float, dict]:
        ...
        # print("****** zoomin tool image_data ******", image_data)
